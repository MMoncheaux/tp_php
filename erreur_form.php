...
<html xmlns="http://www.w3.org/1999/html">
   ...
   <body>
     <div class="container">
       ...
       <div class="paragraph">
         <p>Bonjour <?php if(isset($nom)){ echo $nom." ";} if(isset($prenom)){ echo $prenom;} ?>, l'addresse mail que vous venez d'entrer n'est pas celle de nôtre fichier client</p> <p>Vous pouvez choisir de retourner sur le formulaire en cliquant sur ce  <a href="formulaire.php">lien</a> ou alors vous pouvez contacter le service mass-mailing à  <a href="mailto:support-mail@connectlife.com">l'adresse</a> suivante afin de nous faire part de votre problème.</p>
       </div>
